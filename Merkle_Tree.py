...
class MerkleTree:
    ...
    def MerkleProof(self, val):
        leaf = self.find_leaf(val)
        if leaf == 0:
            return False, []
    ...
    def create_Tree(self, transactions, firstIter, id):
        ...
        if firstIter == True:
            ...
            for i in transactions:
                ...
                hashed_leaf = hexToInt(transactions[i])
...
##### Pour test, décommenter ligne 126-127 et commenter ligne 129 puis tout ce qu'il y a en dessous et executer ce fichier
# test = MerkleTree()
